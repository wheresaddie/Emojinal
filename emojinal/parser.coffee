...
window.Emojinal.execute = (src) ->
  console.log(@compile(src))
  FJS.execute @compile(src)

window.Emojinal.compile = (src) -> @parser.parse (src + " " + @suffix)

window.Emojinal.toAscii = (text) ->
  for emoji, name of Emojinal.names
    text = text.replace new RegExp(emoji, 'g'), "_emoji_#{name}_"
  text

window.Emojinal.parser = PEG.buildParser "
  start           = c:expression+ { return c.join(' ').replace(/ =/g, '=') }

  expression      = e:(literal / emoji) space { return e }

  literal         = string / number

  string          = '✌' s:[^✌]+ '✌' { return '\"' + s.join('') + '\"' }

  number          = d:digit+ { return parseFloat(d.join('')) } 
  digit           = d:ascii_digit '⃣' { return d }
  ascii_digit     = [0123456789]

  emoji           = e:(people_emoji / nature_emoji / object_emoji / symbol_emoji)+ { var symbol = e.join(''); return Emojinal.lookupTable[symbol] ? Emojinal.lookupTable[symbol] : Emojinal.toAscii(symbol); }
  people_emoji    = '😄' / '😃' / '😀' / '😊' / '☺' / '😉' / '😍' / '😘' / '😚' / '😗' / '😙' / '😜' / '😝' / '😛' / '😳' / '😁' / '😔' / '😌' / '😒' / '😞' / '😣' / '😢' / '😂' / '😭' / '😪' / '😥' / '😰' / '😅' / '😓' / '😩' / '😫' / '😨' / '😱' / '😠' / '😡' / '😤' / '😖' / '😆' / '😋' / '😷' / '😎' / '😴' / '😵' / '😲' / '😟' / '😦' / '😧' / '😈' / '👿' / '😮' / '😬' / '😐' / '😕' / '😯' / '😶' / '😇' / '😏' / '😑' / '👲' / '👳' / '👮' / '👷' / '💂' / '👶' / '👦' / '👧' / '👨' / '👩' / '👴' / '👵' / '👱' / '👼' / '👸' / '😺' / '😸' / '😻' / '😽' / '😼' / '🙀' / '😿' / '😹' / '😾' / '👹' / '👺' / '🙈' / '🙉' / '🙊' / '💀' / '👽' / '💩' / '🔥' / '✨' / '🌟' / '💫' / '💥' / '💢' / '💦' / '💧' / '💤' / '💨' / '👂' / '👀' / '👃' / '👅' / '👄' / '👍' / '👎' / '👌' / '👊' / '✊' / '✌' / '👋' / '✋' / '👐' / '👆' / '👇' / '👉' / '👈' / '🙌' / '🙏' / '☝' / '👏' / '💪' / '🚶' / '🏃' / '💃' / '👫' / '👪' / '👬' / '👭' / '💏' / '💑' / '👯' / '🙆' / '🙅' / '💁' / '🙋' / '💆' / '💇' / '💅' / '👰' / '🙎' / '🙍' / '🙇' / '🎩' / '👑' / '👒' / '👟' / '👞' / '👡' / '👠' / '👢' / '👕' / '👔' / '👚' / '👗' / '🎽' / '👖' / '👘' / '👙' / '💼' / '👜' / '👝' / '👛' / '👓' / '🎀' / '🌂' / '💄' / '💛' / '💙' / '💜' / '💚' / '❤' / '💔' / '💗' / '💓' / '💕' / '💖' / '💞' / '💘' / '💌' / '💋' / '💍' / '💎' / '👤' / '👥' / '💬' / '👣' / '💭' 
  nature_emoji    = '🐶' / '🐺' / '🐱' / '🐭' / '🐹' / '🐰' / '🐸' / '🐯' / '🐨' / '🐻' / '🐷' / '🐽' / '🐮' / '🐗' / '🐵' / '🐒' / '🐴' / '🐑' / '🐘' / '🐼' / '🐧' / '🐦' / '🐤' / '🐥' / '🐣' / '🐔' / '🐍' / '🐢' / '🐛' / '🐝' / '🐜' / '🐞' / '🐌' / '🐙' / '🐚' / '🐠' / '🐟' / '🐬' / '🐳' / '🐋' / '🐄' / '🐏' / '🐀' / '🐃' / '🐅' / '🐇' / '🐉' / '🐎' / '🐐' / '🐓' / '🐕' / '🐖' / '🐁' / '🐂' / '🐲' / '🐡' / '🐊' / '🐫' / '🐪' / '🐆' / '🐈' / '🐩' / '🐾' / '💐' / '🌸' / '🌷' / '🍀' / '🌹' / '🌻' / '🌺' / '🍁' / '🍃' / '🍂' / '🌿' / '🌾' / '🍄' / '🌵' / '🌴' / '🌲' / '🌳' / '🌰' / '🌱' / '🌼' / '🌐' / '🌞' / '🌝' / '🌚' / '🌑' / '🌒' / '🌓' / '🌔' / '🌕' / '🌖' / '🌗' / '🌘' / '🌜' / '🌛' / '🌙' / '🌍' / '🌎' / '🌏' / '🌋' / '🌌' / '🌠' / '⭐' / '☀' / '⛅' / '☁' / '⚡' / '☔' / '❄' / '⛄' / '🌀' / '🌁' / '🌈' / '🌊'
  object_emoji    = '🎍' / '💝' / '🎎' / '🎒' / '🎓' / '🎏' / '🎆' / '🎇' / '🎐' / '🎑' / '🎃' / '👻' / '🎅' / '🎄' / '🎁' / '🎋' / '🎉' / '🎊' / '🎈' / '🎌' / '🔮' / '🎥' / '📷' / '📹' / '📼' / '💿' / '📀' / '💽' / '💾' / '💻' / '📱' / '☎' / '📞' / '📟' / '📠' / '📡' / '📺' / '📻' / '🔊' / '🔉' / '🔈' / '🔇' / '🔔' / '🔕' / '📢' / '📣' / '⏳' / '⌛' / '⏰' / '⌚' / '🔓' / '🔒' / '🔏' / '🔐' / '🔑' / '🔎' / '💡' / '🔦' / '🔆' / '🔅' / '🔌' / '🔋' / '🔍' / '🛁' / '🛀' / '🚿' / '🚽' / '🔧' / '🔩' / '🔨' / '🚪' / '🚬' / '💣' / '🔫' / '🔪' / '💊' / '💉' / '💰' / '💴' / '💵' / '💷' / '💶' / '💳' / '💸' / '📲' / '📧' / '📥' / '📤' / '✉' / '📩' / '📨' / '📯' / '📫' / '📪' / '📬' / '📭' / '📮' / '📦' / '📝' / '📄' / '📃' / '📑' / '📊' / '📈' / '📉' / '📜' / '📋' / '📅' / '📆' / '📇' / '📁' / '📂' / '✂' / '📌' / '📎' / '✒' / '✏' / '📏' / '📐' / '📕' / '📗' / '📘' / '📙' / '📓' / '📔' / '📒' / '📚' / '📖' / '🔖' / '📛' / '🔬' / '🔭' / '📰' / '🎨' / '🎬' / '🎤' / '🎧' / '🎼' / '🎵' / '🎶' / '🎹' / '🎻' / '🎺' / '🎷' / '🎸' / '👾' / '🎮' / '🃏' / '🎴' / '🀄' / '🎲' / '🎯' / '🏈' / '🏀' / '⚽' / '⚾' / '🎾' / '🎱' / '🏉' / '🎳' / '⛳' / '🚵' / '🚴' / '🏁' / '🏇' / '🏆' / '🎿' / '🏂' / '🏊' / '🏄' / '🎣' / '☕' / '🍵' / '🍶' / '🍼' / '🍺' / '🍻' / '🍸' / '🍹' / '🍷' / '🍴' / '🍕' / '🍔' / '🍟' / '🍗' / '🍖' / '🍝' / '🍛' / '🍤' / '🍱' / '🍣' / '🍥' / '🍙' / '🍘' / '🍚' / '🍜' / '🍲' / '🍢' / '🍡' / '🍳' / '🍞' / '🍩' / '🍮' / '🍦' / '🍨' / '🍧' / '🎂' / '🍰' / '🍪' / '🍫' / '🍬' / '🍭' / '🍯' / '🍎' / '🍏' / '🍊' / '🍋' / '🍒' / '🍇' / '🍉' / '🍓' / '🍑' / '🍈' / '🍌' / '🍐' / '🍍' / '🍠' / '🍆' / '🍅' / '🌽'
  places_emoji    = '🏠' / '🏡' / '🏫' / '🏢' / '🏣' / '🏥' / '🏦' / '🏪' / '🏩' / '🏨' / '💒' / '⛪' / '🏬' / '🏤' / '🌇' / '🌆' / '🏯' / '🏰' / '⛺' / '🏭' / '🗼' / '🗾' / '🗻' / '🌄' / '🌅' / '🌃' / '🗽' / '🌉' / '🎠' / '🎡' / '⛲' / '🎢' / '🚢' / '⛵' / '🚤' / '🚣' / '⚓' / '🚀' / '✈' / '💺' / '🚁' / '🚂' / '🚊' / '🚉' / '🚞' / '🚆' / '🚄' / '🚅' / '🚈' / '🚇' / '🚝' / '🚋' / '🚃' / '🚎' / '🚌' / '🚍' / '🚙' / '🚘' / '🚗' / '🚕' / '🚖' / '🚛' / '🚚' / '🚨' / '🚓' / '🚔' / '🚒' / '🚑' / '🚐' / '🚲' / '🚡' / '🚟' / '🚠' / '🚜' / '💈' / '🚏' / '🎫' / '🚦' / '🚥' / '⚠' / '🚧' / '🔰' / '⛽' / '🏮' / '🎰' / '♨' / '🗿' / '🎪' / '🎭' / '📍' / '🚩'
  symbol_emoji    = '1⃣' / '2⃣' / '3⃣' / '4⃣' / '5⃣' / '6⃣' / '7⃣' / '8⃣' / '9⃣' / '0⃣' / '🔟' / '🔢' / '#⃣' / '🔣' / '⬆' / '⬇' / '⬅' / '➡' / '🔠' / '🔡' / '🔤' / '↗' / '↖' / '↘' / '↙' / '↔' / '↕' / '🔄' / '◀' / '▶' / '🔼' / '🔽' / '↩' / '↪' / 'ℹ' / '⏪' / '⏩' / '⏫' / '⏬' / '⤵' / '⤴' / '🆗' / '🔀' / '🔁' / '🔂' / '🆕' / '🆙' / '🆒' / '🆓' / '🆖' / '📶' / '🎦' / '🈁' / '🈯' / '🈳' / '🈵' / '🈴' / '🈲' / '🉐' / '🈹' / '🈺' / '🈶' / '🈚' / '🚻' / '🚹' / '🚺' / '🚼' / '🚾' / '🚰' / '🚮' / '🅿' / '♿' / '🚭' / '🈷' / '🈸' / '🈂' / 'Ⓜ' / '🛂' / '🛄' / '🛅' / '🛃' / '🉑' / '㊙' / '㊗' / '🆑' / '🆘' / '🆔' / '🚫' / '🔞' / '📵' / '🚯' / '🚱' / '🚳' / '🚷' / '🚸' / '⛔' / '✳' / '❇' / '❎' / '✅' / '✴' / '💟' / '🆚' / '📳' / '📴' / '🅰' / '🅱' / '🆎' / '🅾' / '💠' / '➿' / '♻' / '♈' / '♉' / '♊' / '♋' / '♌' / '♍' / '♎' / '♏' / '♐' / '♑' / '♒' / '♓' / '⛎' / '🔯' / '🏧' / '💹' / '💲' / '💱' / '©' / '®' / '™' / '❌' / '‼' / '⁉' / '❗' / '❓' / '❕' / '❔' / '⭕' / '🔝' / '🔚' / '🔙' / '🔛' / '🔜' / '🔃' / '🕛' / '🕧' / '🕐' / '🕜' / '🕑' / '🕝' / '🕒' / '🕞' / '🕓' / '🕟' / '🕔' / '🕠' / '🕕' / '🕖' / '🕗' / '🕘' / '🕙' / '🕚' / '🕡' / '🕢' / '🕣' / '🕤' / '🕥' / '🕦' / '✖' / '➕' / '➖' / '➗' / '♠' / '♥' / '♣' / '♦' / '💮' / '💯' / '✔' / '☑' / '🔘' / '🔗' / '➰' / '〰' / '〽' / '🔱' / '◼' / '◻' / '◾' / '◽' / '▪' / '▫' / '🔺' / '🔲' / '🔳' / '⚫' / '⚪' / '🔴' / '🔵' / '🔻' / '⬜' / '⬛' / '🔶' / '🔷' / '🔸' / '🔹'
